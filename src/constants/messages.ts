const MESSAGES = {
  ...
  getUsername: '🧍🏻‍♂️ نام کاربری سایت سماد رو بفرست',
  getPassword: '🔓 حالا رمز سایت سماد رو بفرست ( رمز شما در این ربات ذخیره نمیشود )',
  reserve: 'رزرو غذا',
  back: '←',
